...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        <h1 class="h3 mb-1 fw-bold">Add Book Stand</h1>
        <p class="text-muted mb-0">Create a shelf or location where book copies are stored.</p>
    </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('admin.book-stands.store') }}" method="POST">
            @csrf
